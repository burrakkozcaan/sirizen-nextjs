...
import { ArrowLeft, Package, Camera, X, AlertCircle, Info } from "lucide-react";
              ...
              <>
                ...
                <div className="bg-white rounded-lg shadow-card p-6">
                  ...
                  <RadioGroup
                    value={refundMethod}
                    onValueChange={(v) =>
                      setRefundMethod(v as "original" | "wallet")
                    }
                  >
                      ...
                      <div className="flex items-start space-x-3 p-3 rounded-lg border hover:border-primary transition-colors">
                        ...
                        <div>
                          <Label
                            ...
                            className="cursor-pointer font-medium"
                          >
                            Trendyol Cüzdana İade
                          </Label>
                          <p className="text-sm text-muted-foreground">
                            Anında cüzdanınıza yüklenir, alışverişlerde
                            kullanabilirsiniz
                          </p>
                        </div>
                      </div>
            ...
            <div className="bg-white rounded-lg shadow-card p-6 sticky top-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    {refundMethod === "original" ? "Orijinal Ödeme" : "Cüzdan"}
                  </span>
                </div>
